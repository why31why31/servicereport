...
    s1, s2 = st.columns(2)
    with s1: 
        st.write("Technician Signature:"); ct = st_canvas(stroke_width=2, height=80, width=200, key="ct_can", background_color="rgba(0,0,0,0)")
    with s2: 
        st.write("Customer Signature:"); cc = st_canvas(stroke_width=2, height=80, width=200, key="cc_can", background_color="rgba(0,0,0,0)")
    
