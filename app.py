...
# --- FUNGSI OPTIMASI AGGRESIF (Mencegah Crash 200MB) ---
...
if submitted:
    if not completed_by or not serial_no:
        ...
        if save_to_excel(report_data):
            ...
            st.session_state['sig_t'] = sig_t_img
            st.session_state['sig_c'] = sig_c_img
            st.session_state['logo'] = logo_img
            st.session_state['extra_items'] = list_photos
            st.session_state['img_adj'] = img_adj
