...
def create_pdf(data, sig_t=None, sig_c=None):
    ...
    # Memasukkan Gambar Tanda Tangan (fpdf2 mendukung PIL Image)[cite: 1]
    if sig_t:
    ...
    # Konversi bytearray ke bytes murni agar Streamlit tidak error[cite: 1]
...
if submitted:
    if not report_no or not completed_by:
        ...
        # Simpan ke Excel lalu simpan ke session state untuk PDF[cite: 1]
